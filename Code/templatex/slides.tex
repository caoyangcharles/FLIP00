...
Last Changed by: \textsc{YANG CAO}\ (2021/07/05)
},
cf={PUBG Game Data Analysis and prediction},
}
...
In game, players can pick up different munitions, revive downed-but-not-out (knocked) teammates, drive vehicles, swim, run, shoot,
and experience all of the consequences -- such as falling too far or running themselves over and eliminating themselves.
Different game behaviors will lead to different final rankings, 
so the main purpose is to build a model to predicts players' finishing placement based on their final stats, on a scale from 1 (first place) to 0 (last place).
\begin{itemize}
\item A game team data analyst may be interested in the \textcolor{orange}{game actions} that
make \textcolor{orange}{game teams} \textcolor{orange}{get higher rank} than others.
\item Players can also estimate their final ranking based on the current situation and make strategic decisions in advance (such as running away or fighting).
\end{itemize}
}}
...
%%==========================================================================================
%%
\begin{slide}[toc=,bm=]{Description and Evaluation}
\begin{center}
\twotonebox{\rotatebox{90}{Desc}}{\parbox{.86\textwidth}
{Mean Square Error: the average squared difference between the estimated values and the actual value
\begin{itemize}
\item Train dataset MSE
\item Test Dataset MSE
\end{itemize}
}}
...
%%==========================================================================================
%%
\begin{slide}{Miss vlaue and NaN value}
%Challenges (1)
...
\begin{figure}
  ...
  % \selectcolormodel{rgb}
  % \missingfigure{Testing a long text string.}
  \includegraphics[width=0.55\textwidth, height=0.75\textheight]{missvalue.eps}
  \caption{Miss Value of train dataset} 
  \label{missvalue}
\end{figure}
...
%%==========================================================================================
%%
\begin{slide}[toc=,bm=]{Game type proportion}
\begin{figure}
  \centering
  % \selectcolormodel{rgb}
  % \missingfigure{Testing a long text string.}
...
\begin{slide}[toc=,bm=]{Walk distance with win place}
  \begin{figure}
    \centering
    % \selectcolormodel{rgb}
    % \missingfigure{Testing a long text string.}
...
%%==========================================================================================
%%
\begin{slide}[toc=,bm=]{Correlation}

\begin{figure}
  \centering
  % \selectcolormodel{rgb}
  % \missingfigure{Testing a long text string.}
  \includegraphics[width=1.3\textwidth]{corr.eps}\\
...
%%==========================================================================================
%%
\begin{slide}[toc=,bm=]{High Correlation}
%Step One - Group Feature Extraction}
\begin{figure}
  \centering
  % \selectcolormodel{rgb}
  % \missingfigure{Testing a long text string.}
  \includegraphics[width=1.2\textwidth]{highcorr.eps}\\
  \caption{High Correlation} \label{highcorr}
\end{figure}
...
%%==========================================================================================
%%
\begin{slide}[toc=,bm=]{Linear Regression}

\begin{itemize}
\item Sklearn linear regression parameters on grid search and cross validation.
\end{itemize}

\begin{table}
  \caption{linear regression parameters and cross validation}
...
\begin{itemize}
\item Sklearn Decision Tree parameters on grid search and cross validation.
\end{itemize}

\begin{table}
  \caption{Decision Tree parameters and cross validation}
...
%%==========================================================================================
%%
\begin{slide}{Best Parameters}
\begin{itemize}
\item Best parameters by grid search
\item Linear Regression: copy_X=True, fit_intercept=True, n_jobs=None, normalize=True
\item Decision Tree: ccp_alpha=0.0, criterion='mse', max_depth=None,
...
\begin{itemize}
\item Compare MSE result between Linear regression and Decision Tree
\end{itemize}

\begin{table}
  \caption{Linear regression VS Decision Tree}
...
\item
\smallskip
Both training and testing data shows that linear model get lower mean square error 
value.
...
\begin{description}
 \item[\textcolor{orange}{\faEnvelope}] \href{mailto:caoyang@deakin.edu.au}
 {\textsc{\footnotesize{caoyang@deakin.edu.au}}}
